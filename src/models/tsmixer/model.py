...
class TSMixerConfig(ModelConfig):
    ...
    def __init__(self, **kwargs):
        ...
        base_kwargs = {k: v for k, v in kwargs.items() if k not in tsmixer_specific_params}
...
class TSMixerForecaster(BaseTSFM):
    ...
    def __init__(self, config: TSMixerConfig, lora_config=None, distributed_config=None):
    ...
    def _prepare_data(
        ...
        raise NotImplementedError("TSMixer integration is a placeholder - not yet implemented")
