...
class TTMConfig(ModelConfig):
    ...
    # --- Data features ---
    # Default to univariate (CGM-only) so it matches num_input_channels=1.
    # To use covariates, override input_features AND num_input_channels in YAML
    # (e.g. configs/models/ttm/02_fine_tune_00plus_insulin.yaml).
