...
mirroring the structure of other CGM dataset loaders. It handles both train
...
class Lynch2022DataLoader(DatasetBase):
    ...
    def _process_raw_train_data(
        ...
        # Split data into per-patient dictionary FIRST
        multipatient_data_dict = split_multipatient_dataframe(
            pre_processed_data, "p_num"
        )

        # Create tuples from the dictionary
        patient_data_tuples = [
        ...
        # Save full processed data (before split) to cache
    ...
    def _split_train_validation(self):
        ...
        # Try to load existing split data
        ...
        if cached_split_data is not None:
            ...
            # Save split data to cache using serialized format
