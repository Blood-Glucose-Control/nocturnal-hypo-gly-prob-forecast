...
class MovingAverageTransformer(BaseTransformer):
    ...
    def fit(self, X: Union[pd.Series, pd.DataFrame], y=None) -> 'MovingAverageTransformer':
        """
...
class ExponentialSmoothingTransformer(BaseTransformer):
    ...
    def fit(self, X: Union[pd.Series, pd.DataFrame], y=None) -> 'ExponentialSmoothingTransformer':
        """
