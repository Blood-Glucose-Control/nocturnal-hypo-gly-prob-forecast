#!/usr/bin/env python3
"""Event-detection sweep evaluation adapter scaffold."""
...
def _build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="Event-detection sweep evaluation adapter scaffold."
    )
    parser.add_argument(
        "--model-type",
        type=str,
        default=None,
        help="Model type identifier for event-detection evaluation sweeps.",
    )
    parser.add_argument(
        "--sweep-spec",
        type=str,
