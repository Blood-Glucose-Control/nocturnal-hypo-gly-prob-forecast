#!/usr/bin/env python3
"""Task/experiment-aware sweep evaluation dispatcher."""
...
def _build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description=(
            "Dispatch sweep evaluation orchestration by task family and experiment type."
        ),
        add_help=False,
    )
    parser.add_argument(
