...
scripts/evaluation/nocturnal_hypo_eval.py instead.

Usage:
    python scripts/evaluation/sliding_window_eval.py --model sundial --dataset brown_2019
    python scripts/evaluation/sliding_window_eval.py --model ttm --dataset brown_2019
    python scripts/evaluation/sliding_window_eval.py --model sundial --context-length 512 --forecast-length 72
    python scripts/evaluation/sliding_window_eval.py --model sundial --model-config configs/models/sundial.yaml
    python scripts/evaluation/sliding_window_eval.py --model sundial --checkpoint path/to/checkpoint

    # TTM zero-shot (no checkpoint):
    python scripts/evaluation/sliding_window_eval.py \
        --model ttm \
        --dataset brown_2019 \
        --context-length 512 \
        --forecast-length 96 \
...
def save_experiment_config(
    ...
    cmd_parts = ["python", "scripts/evaluation/sliding_window_eval.py"]
