...
from src.utils.logging_helper import info_print, error_print, debug_print, _get_caller_name
...
class TestLoggingHelper(unittest.TestCase):
    ...
    def test_real_world_usage_scenario(self):
        ...
        self.assertIn("ERROR: [train_model] Warning: some predictions were NaN", lines[3])
...
class TestIntegrationWithExistingCode(unittest.TestCase):
    ...
    def test_backward_compatibility(self):
        ...
        self.assertIn("INFO: [existing_function_pattern] Model training started", output)
        self.assertIn("DEBUG: [existing_function_pattern] Loading data from cache", output)
