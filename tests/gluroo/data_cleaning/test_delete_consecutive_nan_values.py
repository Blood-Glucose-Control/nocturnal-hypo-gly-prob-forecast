from src.data.gluroo.data_cleaner import erase_consecutive_nan_values
...
class TestDeleteConsecutiveNanValues:
    ...
    def test_more_than_max_consecutive_nan_values_per_day_deleted(
        self, noisy_df, max_consecutive_nan_values_per_day
    ):
        """
    ...
    def test_fewer_than_max_consecutive_nan_values_per_day_kept(
        self, noisy_df, max_consecutive_nan_values_per_day
    ):
        """
