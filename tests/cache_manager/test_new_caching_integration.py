...
class TestNewCachingIntegration:
    ...
    def test_full_caching_workflow(self):
        ...
        for patient_id in mock_processed_data.keys():
            ...
            pd.testing.assert_frame_equal(
                train_data[patient_id], loaded_train[patient_id]
            )
            pd.testing.assert_frame_equal(
                validation_data[patient_id], loaded_val[patient_id]
            )
    ...
    def test_cache_manager_new_methods_work(self):
        ...
        pd.testing.assert_frame_equal(
            processed_data["patient_001"], loaded_data["patient_001"]
        )
        ...
        pd.testing.assert_frame_equal(
            val_data["patient_001"], loaded_val["patient_001"]
        )
