...
USAGE:
    python scripts/experiments/chronos2_time_covariate_experiment.py --arm CD
    python scripts/experiments/chronos2_time_covariate_experiment.py --arm all --steps 10000
    python scripts/experiments/chronos2_time_covariate_experiment.py --arm D
"""
