        ...
        try:
            ...
            if "error" in info:
                ...
                if "temporal_split" in info:
                    ...
                    logger.info(f"  Holdout Percentage: {ts['holdout_percentage']*100:.1f}%")
                ...
                if "patient_split" in info:
                    ...
                    logger.info(f"  Number of Holdout Patients: {ps['num_holdout_patients']}")
                    logger.info(f"  Holdout Patients: {', '.join(ps['holdout_patients'])}")
