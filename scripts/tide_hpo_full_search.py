...
def main():
    ...
    # FULL SEARCH: Search encoder/decoder dims independently
    # NOTE: ~60% of trials will fail (encoder != decoder), but we'll find best dims
    search_space = {
        "TiDE": {
            # HIGH IMPACT - Tune these (including dims!)
    ...
    print("FULL SEARCH SPACE (Ray Bayesian optimization):")
    print("  encoder_hidden_dim: [256, 384, 512]")
    print("  decoder_hidden_dim: [256, 384, 512]")
    ...
    print("\nNOTE: Trials with encoder != decoder will fail (matrix mult error)")
    print("      Expected ~6-9 valid trials out of 15")
    print("\nFixed parameters:")
    ...
    results = {
        "config": "TiDE HPO FULL SEARCH - Ray Bayesian Optimization",
        "num_trials": args.num_trials,
        "time_limit": args.time_limit,
        "search_space": {
            "encoder_hidden_dim": [256, 384, 512],
            "decoder_hidden_dim": [256, 384, 512],
        ...
        "note": "~60% trials expected to fail (encoder != decoder matrix mult error)",
