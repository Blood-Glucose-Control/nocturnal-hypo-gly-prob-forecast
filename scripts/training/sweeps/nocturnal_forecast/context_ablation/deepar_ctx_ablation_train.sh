...
#
# Usage:
#   bash scripts/training/sweeps/nocturnal_forecast/context_ablation/deepar_ctx_ablation_train.sh
#   GPUS="0 1" JOBS_PER_GPU=2 bash scripts/training/sweeps/nocturnal_forecast/context_ablation/deepar_ctx_ablation_train.sh 2>&1 | tee logs/ctx_ablation_deepar_train.log
