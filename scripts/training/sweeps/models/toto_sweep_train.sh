...
#   trained_models/artifacts/toto/<date>_RID<id>_forecasting_workflow
...
for entry in "${CONFIGS[@]}"; do
    ...
    out_dir="trained_models/artifacts/toto/$(date +%Y-%m-%d_%H:%M)_RID${RUN_ID}_forecasting_workflow"
