...
Usage Examples:
    ...
    python scripts/data_processing/generate_holdout_configs.py --datasets lynch_2022 brown_2019

    # Generate temporal-only configs
    python scripts/data_processing/generate_holdout_configs.py --split-type temporal

    # Generate patient-only configs
    python scripts/data_processing/generate_holdout_configs.py --split-type patient

    # Custom holdout percentages
    python scripts/data_processing/generate_holdout_configs.py --temporal-pct 0.15 --patient-pct 0.15
"""
