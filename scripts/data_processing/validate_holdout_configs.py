...
Usage Examples:
    ...
    python scripts/data_processing/validate_holdout_configs.py --config-dir configs/data/holdout_5pct

    # Validate specific dataset (shows detailed info + validation)
    python scripts/data_processing/validate_holdout_configs.py lynch_2022

    # Validate specific dataset with custom config directory
    python scripts/data_processing/validate_holdout_configs.py lynch_2022 --config-dir configs/data/holdout_5pct
