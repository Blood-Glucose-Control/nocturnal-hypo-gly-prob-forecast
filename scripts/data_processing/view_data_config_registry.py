...
Usage:
    # View summary
    python scripts/data_processing/view_data_config_registry.py

    # View recent entries
    python scripts/data_processing/view_data_config_registry.py --recent 5

    # Filter by dataset
    python scripts/data_processing/view_data_config_registry.py --dataset lynch_2022

    # Filter by branch
    python scripts/data_processing/view_data_config_registry.py --branch main

    # Export to CSV
    python scripts/data_processing/view_data_config_registry.py --export data_config_registry.csv
"""
