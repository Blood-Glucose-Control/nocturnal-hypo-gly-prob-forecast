#!/usr/bin/env bash
# Profile launcher for Moirai forecast sweep evaluation.
#
...
SWEEP_SPEC="configs/experiments/nocturnal_forecast/moirai_forecasting_eval_sweep.yaml" \
EVAL_PYTHON="${EVAL_PYTHON:-.venvs/moirai/bin/python}" \
