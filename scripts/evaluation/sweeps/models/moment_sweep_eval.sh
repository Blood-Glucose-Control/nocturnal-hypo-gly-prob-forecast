#!/usr/bin/env bash
# Profile launcher for MOMENT forecast sweep evaluation.
#
...
SWEEP_SPEC="configs/experiments/nocturnal_forecast/moment_forecasting_eval_sweep.yaml" \
EVAL_PYTHON="${EVAL_PYTHON:-.venvs/moment/bin/python}" \
