#!/usr/bin/env bash
# Profile launcher for Toto forecast sweep evaluation.
#
...
SWEEP_SPEC="configs/experiments/nocturnal_forecast/toto_forecasting_eval_sweep.yaml" \
EVAL_PYTHON="${EVAL_PYTHON:-.venvs/toto/bin/python}" \
