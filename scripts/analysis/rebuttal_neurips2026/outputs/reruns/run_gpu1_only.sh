...
echo "[GPU1] a4_ttm_lynch_2022 (expect RMSE~2.52)"
.venvs/ttm/bin/python scripts/experiments/nocturnal_hypo_eval.py --model ttm --dataset lynch_2022 --config-dir configs/data/holdout_10pct --context-length 512 --forecast-length 96 --cuda-device 1 --output-dir experiments/nocturnal_forecasting/512ctx_96fh/ttm/rebuttal_lynch_2022_finetuned --checkpoint /data/home/cjrisi/nocturnal/trained_models/artifacts/ttm/2026-02-27_03:53_RID20260227_035316_193673_holdout_workflow/model.pt --covariate-cols > scripts/analysis/rebuttal_neurips2026/outputs/reruns/logs/a4_ttm_lynch_2022.log 2>&1
echo "  -> exit $? : a4_ttm_lynch_2022"
