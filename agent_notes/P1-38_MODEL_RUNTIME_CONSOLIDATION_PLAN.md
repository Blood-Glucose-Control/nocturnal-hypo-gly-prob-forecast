...
1. Continue PR-C4 with WS1-TOT-01 and WS1-TID-01 helper extraction slices.
2. Execute WS1-CHR-02 utility-boundary/no-caller proof for `chronos2/utils.py` and `chronos2/visualization.py`.
3. Keep dependency-lane targeted validations and final Pylance gates per touched C4 file.
...
### PR-C4 status checkpoint (2026-08-27, Chronos2 slice 1)
